...
SECRET_KEY = 'django-insecure-ty*(f-9xj=yt0--(%ljnz3h*xl3u-&i=gq$l3n3knyhkims@!9'
...
MIDDLEWARE = [
    ...
    'water_management.middleware.UserTypeRestrictionMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('DB_PASSWORD','12341234'),  # Rzs3MQ8molPY
...
LOGIN_REDIRECT_URL = '/'  # Redirects to the home URL (which auto-redirects to the correct dashboard)
